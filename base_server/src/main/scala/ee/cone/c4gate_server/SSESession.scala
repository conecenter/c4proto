...
@c4("NoProxySSEConfigApp") final case class NoProxySSEConfig()(
  config: Config,
  ...
  def tolerateOfflineSeconds: Int = Single.option(listConfig.get("C4TOLERATE_OFFLINE_SECONDS")).fold(60)(_.toInt)
