...
import ee.cone.c4actor.{BaseApp, EnvConfigCompApp, ExecutableApp, KafkaConsumerApp, KafkaProducerApp, NoAssembleProfilerApp, RichDataCompApp, SnapshotLoaderImplApp, SnapshotUtilImplApp, VMExecutionApp}
