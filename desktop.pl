...
push @tasks, [sshd=>sub{
    ...
    sy('mkdir -p /c4/dropbear /c4/.ssh && touch /c4/.ssh/authorized_keys');
    sy('chmod go-rwx /c4 /c4/.ssh /c4/.ssh/authorized_keys');
