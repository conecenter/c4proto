...
import ee.cone.c4actor.{ProtocolsApp, TestOrigCat}
...
@protocol(TestOrigCat) object SandboxProtocol extends Protocol {
...
@protocol(TestOrigCat) object OtherProtocol extends Protocol {
