...
@protocol(TestCat) object PerformanceProtocol   {
...
@assemble class LUL[Model, Model2, Model3](modelCl: Class[Model], model2: Class[Model2], model3: Class[Model3])   {
...
@assemble class ChangingIndexAssemble(constant: NodeInstruction)   {
