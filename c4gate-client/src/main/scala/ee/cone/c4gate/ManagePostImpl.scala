...
@assemble class ManagementPostAssembleBase(actorName: String, indexUtil: IndexUtil, readModelUtil: ReadModelUtil)   {
...
case class ManageHttpPostTx(srcId: SrcId, post: S_HttpPost)(indexUtil: IndexUtil, readModelUtil: ReadModelUtil) extends TxTransform with LazyLogging {
