...
@protocol(DepRequestCat) object ByPKRequestProtocol   {
...
@assemble class ByPKGenericAssemble[A <: Product](handledClass: Class[A], util: DepResponseFactory)   {
