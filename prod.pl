...
my $prod_image_steps = sub{(
    ...
    #"RUN perl install.pl curl https://downloads.apache.org/kafka/3.5.1/kafka_2.13-3.5.1.tgz",
    "RUN perl install.pl curl https://downloads.apache.org/kafka/3.9.2/kafka_2.13-3.9.2.tgz",
