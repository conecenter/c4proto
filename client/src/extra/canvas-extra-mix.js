...
export default function CanvasExtraMix(log){ // Canvas.ExchangeCanvasSetup(canvas,feedback,()=>document.body)
    return options => canvas => [
        ...
        options.scrollViewPosition ? (options.maxViewHeight ? CanvasExtra.ScrollViewPositionMaxHeightCanvasSetup(canvas):CanvasExtra.ScrollViewPositionCanvasSetup(canvas)) : Canvas.DragViewPositionCanvasSetup(canvas),
