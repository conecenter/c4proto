...
import { InputElement } from "../test/MockData.jsx"
...
export function FilterArea({filters,buttons,className,maxFilterAreaWidth}){
    ...
    const style = { position: "relative", height: yRowToEm(groupedFilters.length), maxWidth: maxFilterAreaWidth ? em(maxFilterAreaWidth) : "100vw" }
