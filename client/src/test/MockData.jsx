...
import { ImageElement } from '../temp/image'
...
export function ByCell() {
    const srlIcon = <ImageElement src="../temp/servicerequestline.svg" className="rowIconSize" key="image1" />
    const srIcon = <ImageElement src="../temp/servicerequestline.svg" className="rowIconSize" key="image2" />
...
export function InputElement({ value }) {
    return (
...
export function ButtonElement({ caption, BGcolor, onClick }) {
    return (
